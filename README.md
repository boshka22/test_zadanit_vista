...
Это тестовое задание от компании ВИСТА. Формулировка задания была такая: 
Написать приложение-ежедневник (Backend). Должна быть возможность создавать запись, редактировать запись, удалять запись, читать запись, просматривать список записей, помечать запись отработанной. Использовать Python, FastAPI/Flask, PostgreSQL/MySQL. Приложение нужно выложить на гитхаб и написать к нему README.md.

В этом репозитории вы можете ознакомиться с моей реализацией.
